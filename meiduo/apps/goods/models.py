...
class SKU(BaseModel):
    ...
    class Meta:
        db_table = 'tb_sku'
        verbose_name = verbose_name_plural = '商品sku'
...
class SPUSpecification(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '商品的SPU规格'

    def __str__(self):
        return '%s: %s' % (self.spu.name, self.name)


class SpecificationsOption(BaseModel):
    """规格选项"""
    spec = models.ForeignKey(SPUSpecification, on_delete=models.CASCADE, related_name='options', verbose_name='规格')
    value = models.CharField(max_length=20, verbose_name='选项值')

    class Meta:
        db_table = 'tb_specification_option'
        verbose_name = verbose_name_plural = '规格选项'
...
class SKUSpecification(BaseModel):
    ...
    option = models.ForeignKey(SpecificationsOption, on_delete=models.PROTECT, verbose_name='规格值')
