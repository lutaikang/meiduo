...
class OrderInfo(BaseModel):
    ...
    status = models.SmallIntegerField(choices=ORDER_STATUS_CHOICES, default=1, verbose_name='支付状态')

    class Meta:
        db_table = 'tb_order_info'
        verbose_name = verbose_name_plural = '订单基本信息'
...
class OrderGoods(BaseModel):
    ...
    score = models.SmallIntegerField(choices=SCORE_CHOICES, default=5, verbose_name='满意度评价')
